  ...
  for (dato of movies){
    ...
    <div class="col">
              <div class="card">
                <img src="${dato.poster}">
                <div class="card-body">
                  <h5 class="card-title">${dato.title}Card title</h5>
                  <p class="card-text">${dato.plot}This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                </div>
              </div>
            </div>
  `;
