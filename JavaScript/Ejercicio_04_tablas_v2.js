...
//Agregar una columna extra a la tabla y que cada fila tenga un boton que diga eliminar y al darle click elimine la fila correspondiente
...
function crearTabla() {
    ...
    for (const dato of datos) {
        ...
        cadena = cadena + `<td><button class="btn-eliminar" onclick="eliminarFila(event)">Eliminar</button></td>`; 
        cadena = cadena + "</tr>";
    }
    cadena = cadena + "</tbody>";
    cadena = cadena + "</table>";
...
function agregarFila() {
    ...
    if (id && nombre && apellido && correo && telefono && comentario) {
        ...
        <td>${telefono}</td>
        <td>${comentario}</td>
        <td><button class="btn-eliminar" onclick="eliminarFila(event)">Eliminar</button></td>
        `;
